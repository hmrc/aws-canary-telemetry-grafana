...
SCREENSHOT_ON_STEP_START = bool(os.getenv("SCREENSHOT_ON_STEP_START", False))
SCREENSHOT_ON_STEP_SUCCESS = bool(os.getenv("SCREENSHOT_ON_STEP_SUCCESS", False))
SCREENSHOT_ON_STEP_FAILURE = bool(os.getenv("SCREENSHOT_ON_STEP_FAILURE", True))
